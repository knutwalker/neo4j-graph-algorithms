...
import org.neo4j.graphalgo.api2.HugeIdMapping;
...
public final class PagedDisjointSetStruct {
    ...
    private final HugeHugeLongArray parent;
    private final HugeHugeLongArray depth;
    private final long capacity;

    public PagedDisjointSetStruct(long capacity, AllocationTracker tracker) {
        parent = HugeHugeLongArray.newArray(capacity, tracker);
        depth = HugeHugeLongArray.newArray(capacity, tracker);
    ...
    public PagedDisjointSetStruct merge(PagedDisjointSetStruct other) {
        ...
        HugeHugeLongArray.Cursor others = other.parent.cursor(other.parent.newCursor());
        long i = 0L;
        while (others.next()) {
